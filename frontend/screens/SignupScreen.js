        ...
        <View style={tw`bg-white h-full w-full`}>
            ...
            <View style={tw`h-full w-full flex justify-start pt-60 pb-10 mt-12`}>
                <View style={tw`flex items-center mb-5`}>
                    <Animated.Text entering={FadeInUp.duration(1000).springify()} style={tw`text-[#0081E4] font-bold tracking-wider text-5xl`}>Register</Animated.Text>
                </View>

                <View style={tw`flex items-center mx-4 gap-y-4`}>
                    <Formik initialValues={{username: "", email: "", password: ""}} onSubmit={handleRegister} validationSchema={validationSchema}>
                        {({
                            handleChange,
                            handleBlur,
                            handleSubmit,
                            ...
                            <View style={tw`p-5 w-full gap-y-3`}>
                                <Animated.View entering={FadeInDown.duration(1000).springify()} style={tw`bg-white flex-row rounded-2xl w-full border h-15`}>
                                    <Ionicons name="person-outline" size={30} style={tw`self-center pl-2`}/>
                                    <TextInput
                                ...
                                <Animated.View entering={FadeInDown.duration(1000).delay(200).springify()} style={tw`bg-white flex-row rounded-2xl w-full border h-15`}>
